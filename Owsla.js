...
client.ayarlar = {
  "prefix": [".", "!", "s!", "S!"],
  "token": "",
  "yapimci": ["825743202677424149"],
  "footer": "Morbless 💙 REGINALD",
  "readyFooter": ["Morbless 💙 REGINALD"],
...
const sayiEmojiler = {
  0: `<a:rgd_sifir:897903015338602557>`, 
  1: `<a:rgd_bir:897903013098840094>`, 
  2: `<a:rgd_iki:897903016093552771>`, 
  3: `<a:rgd_uc:897903025262325810>`, 
  4: `<a:rgd_dort:897903028311580682>`, 
  5: `<a:rgd_bes:897903026487050280>`, 
  6: `<a:rgd_alti:897903027451736064>`, 
  7: `<a:rgd_yedi:897903024058556470>`, 
  8: `<a:rgd_sekiz:897903020375937074>`, 
  9: `<a:rgd_dokuz:897903022934491176>` 
};
...
client.on("ready", () => {
  client.channels.cache.get("892902531515154482").join();
}) 
